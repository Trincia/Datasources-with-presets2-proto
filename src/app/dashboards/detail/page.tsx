    ...
    >
      <div className="flex h-full flex-col overflow-hidden">
        ...
        <div className="flex shrink-0 items-center border-b border-border px-2 h-9">
          {/* Data tab (active) */}
          <Button variant="ghost" className="relative h-full gap-1.5 px-3 text-xs font-semibold text-primary rounded-none after:absolute after:bottom-0 after:left-0 after:right-0 after:h-[2px] after:bg-primary hover:bg-transparent">
          ...
          <div className="flex flex-1 flex-col overflow-hidden">
            ...
            <div className="flex shrink-0 items-center justify-between border-b border-border px-3">
              ...
              <Tabs value={gridTab} onValueChange={(v) => setGridTab(v as GridTab)}>
                <TabsList variant="line" className="h-9 rounded-none border-0 bg-transparent p-0">
